...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style="text-align:left">yes, if Boundary condition = On edge</td>
    ...
    <tr>
      ...
      <td style="text-align:left">yes, if Boundary condition action = On subregion edge</td>
    ...
    <tr>
      ...
      <td style="text-align:left">yes, if Boundary condition action = On opening edge</td>
