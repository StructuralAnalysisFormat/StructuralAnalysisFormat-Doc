...
## 2.1.2023 Small description update
   * In [StructuralPointSupport](../supports-and-hinges/structuralpointsupport.md) description for property "Node" udpated with link to [StructuralPointConnection](../structural-analysis-elements/structuralpointconnection.md) 
